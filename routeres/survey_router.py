...
def load_tourism_data():
    ...
    try:
        ...
        file_paths = [
            ...
            'WhereWeGo-backend/model/sort3preference.json',
            'WhereWeGo-backend/model/sort3Wpreference.json',
            os.path.join(project_root, 'WhereWeGo-backend/model/sort3preference.json'),
            os.path.join(project_root, 'WhereWeGo-backend/model/sort3Wpreference.json'),
            os.path.join(ncf_modular_root, 'WhereWeGo-backend/model/sort3preference.json'),
            os.path.join(ncf_modular_root, 'WhereWeGo-backend/model/sort3Wpreference.json'),
            # 절대 경로
            'C:/Users/user/Desktop/새 폴더 (2)/.vscode/WhereWeGo-backend/model/sort3preference.json',
            'C:/Users/user/Desktop/새 폴더 (2)/.vscode/WhereWeGo-backend/model/sort3Wpreference.json',
            'C:/Users/user/PycharmProjects/ncf_modular/sort3preference.json',
